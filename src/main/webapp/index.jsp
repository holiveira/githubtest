			...
			<ul>
				<li>
					...
					<span class="checkboxtext">
						1. A nomenclatura do branch contém o nome do projeto?
					</span>
				</li>
<!-- 				<li>
					<input type="checkbox" name="item01" id="item01" placeholder="Email" required />
					Criou teste unitário para a nova atualização?
				</li>
				<li>
					<input type="checkbox" name="item01" id="item01" placeholder="Email" required />
				...
				<li>
					<input type="checkbox" name="item01" id="item01" placeholder="Email" required />
					Criou teste integrado para a nova atualização?
				</li>
				<li>
					<input type="checkbox" name="item01" id="item01" placeholder="Email" required />
 ...
 -->				<li>
				...
				<li>
					...
					<p>4. Inseriu comentário no commit com o nr da issue?</p>
				</li>
				<li>
				...
				<li>
					...
					<p>8. Pacote ficou disponível no nexus?</p>
				</li>
			</ul>
